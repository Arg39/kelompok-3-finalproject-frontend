...
export default function Register(){
  ...
  <div className="md:w-1/3 ">
    ...
    <h1 className="font-bold text-2xl text-start text-white font-serif ml-10 mt-4">Welcome to RENT ID</h1>
    <p className="font-medium text-white text-lg text-start ml-10">Please complete to create your account</p>
  ...
  <div className="md:w-2/3 h-screen relative">
    <img src={imgregister} alt="" className="md:w-full md:h-full md:block hidden object-cover" />
  </div>
</div>
